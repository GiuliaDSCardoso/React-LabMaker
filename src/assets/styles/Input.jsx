  ...
  return (
    <div className="flex flex-col  w-full">
      ...
      <input
        ...
        className="w-[500px] h-[40px] px-3  text-[#2756ac] placeholder:text-[#2756ac] bg-[#e5eeff] outline-none focus:text-[#4c82e6] focus:outline-none focus:ring-1 focus:ring-none"
      />
    </div>
  );
}
